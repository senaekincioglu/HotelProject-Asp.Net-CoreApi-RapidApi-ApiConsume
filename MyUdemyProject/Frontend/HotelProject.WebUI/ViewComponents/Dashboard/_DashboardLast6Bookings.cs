...
namespace HotelProject.WebUI.ViewComponents.Dashboard
{
    public class _DashboardLast6Bookings:ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync() //Personel lİSTELEME
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44384/api/Booking/Last6Booking"); //Sadece verileri listeleyeceğimiz için get metodu kullanıldı. bu da api de get kısmından alındı.
